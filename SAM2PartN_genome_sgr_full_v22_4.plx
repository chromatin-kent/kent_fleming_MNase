#!/usr/bin/perl
#################################################################################
#WARNING: FOR Yeast SacCer3 aligned reads ONLY
#################################################################################
...
# Fiddled with: Nick Kent, April 2nd 2022 to convert long RefSeq chr ID to SacCer3 form
#################################################################################
...
#
# This script will just about run on a 16Gb memory Laptop, but probably more comfortable on a high memory
...
#
# To do (never): MORE ERROR TRAPPING (e.g. non-sorted .sam; general f**k-wittery;); rename test variables.
################################################################################
