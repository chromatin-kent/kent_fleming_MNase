...
# Modified: Nick Kent 19th Jan 2024 - reverted logic to original "Site_Writer" structure to accept 
...
# USAGE:- perl Strandedsite_vs_Anysgr_to_CFD_v24_2.plx
#
# FUNCTION:
...
$datestring =~ tr/:/-/;
print "\n\n*********************************************";
print "\n* Any .sgr versus a .site list -> CFD data *";
print "\n*********************************************\n";
