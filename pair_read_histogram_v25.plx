...
#
# This script takes takes a paired read SAM format file (/in) and produces a frequency 
# distribution of the ISIZE values in a user specificed range and resolution for 
# plotting as a histogram next to an EtBr-stained gel or whatever (/out).
#
# You could apply this to a whole .sam output file from Bowtie. If you use another
# format, you will have to specify the expected file-ending at line 63.
#
# NOTE: the script will process up to the first 10,000,000 reads (unless you change
# the value at line 88. 
#
################################################################################
use strict;
use warnings;
